...
import { isCurrentPath } from "@features/layout/utilities/is-current-path";
...
export function Header() {
  return (
    <header className="fixed left-0 top-0 z-10 flex h-[var(--header-height)] w-full items-center justify-start gap-6 border-b border-solid border-neutral-200 bg-white px-4 dark:bg-neutral-900 sm:justify-start">
