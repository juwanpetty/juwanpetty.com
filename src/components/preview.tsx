...
export function Preview({ children }: PreviewProps) {
  return (
    <div className="bg-background border-border relative flex flex-col overflow-hidden rounded-2xl border p-0.5 [contain-intrinsic-size:0_400px] [content-visibility:auto]">
